...
import '../pages/home/welcome_screen.dart';
...
class RouteHelper {
  ...
  static String getForumCommentReplies(int forum, int comment) =>
      "$forumCommentReplies?forum=$forum&&comment=$comment";
  static String getInitial() => "$initial";
  static String getCropDetail(int id, String side, int index) =>
      "$cropDetail?id=$id&&index=$index&&side=$side";
  static String getSearchCropDetail(int id, int index) =>
      "$searchCropDetail?id=$id&&index=$index";

  static List<GetPage> routes = [
    GetPage(name: splashPage, page: () => SplashScreen()),
    GetPage(name: welcome, page: () => WelcomeScreen()),
    GetPage(
        name: login, page: () => SingInPage(), transition: Transition.fadeIn),
    GetPage(
        name: test, page: () => MapTesting(), transition: Transition.fadeIn),
    GetPage(
        name: userHome,
        page: () => UserHomePage(),
    ...
    GetPage(
        ...
        transition: Transition.fadeIn),
    GetPage(
        name: searchCropDetail,
        page: () {
          var index = Get.parameters['index'];
          var id = Get.parameters['id'];
          return SearchCropDetails(
            index: int.parse(index!),
            id: int.parse(id!),
          );
        },
