...
class _DrawerPageState extends State<DrawerPage> {
  ...
  Widget build(BuildContext context) {
    return Drawer(child: GetBuilder<AuthController>(builder: (authcontroller) {
      return ListView(
        padding: EdgeInsets.zero,
        children: [
          Container(
            height: Dimensions.height30(context) *
                5, // Modifier la hauteur du DrawerHeader ici
            child: DrawerHeader(
                      ...
                      child: Container(
                        ...
                        child: CircleAvatar(
                          ...
                          child: Icon(
                            Icons.person,
                            color: Colors.white,
                            size: Dimensions.height20(context) * 3,
                          ),
                        ),
                      ),
                    ),
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              clipper(15, authcontroller.user.username,
                                  Dimensions.width30(context) * 2),
                              maxLines: 1,
                              style: TextStyle(
          ...
          Divider(
            // Ajoute une ligne de séparation avec une bordure en bas
            color: Colors.grey, // Couleur de la ligne de séparation
            thickness: Dimensions.height10(context) *
                0.1, // Épaisseur de la ligne de séparation
            indent: Dimensions.width10(
                context), // Retrait de la ligne de séparation à gauche
            endIndent: Dimensions.width10(
                context), // Retrait de la ligne de séparation à droite
          ),
          Container(
            height: Dimensions.height30(context) * 1.6,
            child: ListTile(
