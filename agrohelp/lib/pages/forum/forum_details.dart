...
class ForumDetailsPage extends StatefulWidget {
  final int forum;
  const ForumDetailsPage({super.key, required this.forum});
              ...
              Row(
                children: [
                  ...
                  Expanded(
                    ...
                    child: Text(
                      "Question de ${forumcontroller.forums[widget.forum].author.username}",
                      style: TextStyle(
                ...
                child: Container(
                  child: Column(children: [
                    Container(
                      ...
                      color: Color.fromARGB(255, 231, 230, 230),
                      child: Text(
                        forumcontroller.forums[widget.forum].content,
                        style: TextStyle(
                          fontFamily: 'Chakra_Petch',
                    ...
                    for (int i = 0;
                        i <
                            forumcontroller
                                .forums[widget.forum].comments.length;
                        i++) ...[
                      Column(
                        children: [
                          CommentItem(
                              comment: forumcontroller
                                  .forums[widget.forum].comments[i]),
                          SizedBox(
                            height: Dimensions.height10(context),
                          ),
                          Container(
                            ...
                            Expanded(
                              ...
                              decoration: InputDecoration(
                                contentPadding: EdgeInsets.only(
                                    ...
                                    left: Dimensions.height10(context) * 0.8),
