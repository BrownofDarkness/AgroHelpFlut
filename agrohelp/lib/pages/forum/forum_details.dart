                ...
                child: Container(
                  child: Column(
                    children: [
                      ...
                      for (int i=0; i<forumcontroller.forums[widget.forum].comments.length; i++)...[
                        Column(
                          children: [
                            CommentItem(comment:forumcontroller.forums[widget.forum].comments[i]),
                            SizedBox(height: Dimensions.height10(context),),
                            Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Text(
                                          forumcontroller.forums[widget.forum].comments[i].replies.length.toString(),
                                          style: TextStyle(
                                            fontFamily: 'Chakra_Petch',
                                  ...
                                  RichText(
                                    text: TextSpan(
                                      recognizer: TapGestureRecognizer()..onTap=()=>Get.toNamed(RouteHelper.getForumCommentReplies(widget.forum,i)),
                                      text: "répondre",
                                      style: TextStyle(
                                          fontFamily: 'Chakra_Petch',
