...
class _CommentRepliesState extends State<CommentReplies> {
  ...
  void initSocket() {
    ...
    String url =
        '${AppConstants.WS_URL}/ws/forum_chat/$forumId/?token=$userToken';
                ...
                child: SingleChildScrollView(
                  child: Container(
                    child: Column(children: [
                      CommentItem(
                          comment: forumcontroller
                              .forums[widget.forum].comments[widget.comment]),
                      SizedBox(
                        height: Dimensions.height10(context),
                      ),
                      Container(
                          ...
                          padding: EdgeInsets.only(
                              right: Dimensions.width30(context) * 2),
                          child: Row(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Icon(
                                      ...
                                      size: Dimensions.height20(context) * 1.2,
                                      color: Color.fromARGB(255, 15, 92, 17),
                                    ),
                                    SizedBox(
                                      width: Dimensions.width20(context) * 0.25,
                                    ),
                                    Text(
                                      forumcontroller
                                          .forums[widget.forum]
                      ...
                      for (int j = 0;
                          j <
                              forumcontroller.forums[widget.forum]
                                  .comments[widget.comment].replies!.length;
                          j++) ...[
                        ReplieItem(
                          replie: forumcontroller.forums[widget.forum]
                              .comments[widget.comment].replies[j],
                        ),
                        SizedBox(
                          height: Dimensions.height10(context),
                        ),
              ...
              Container(
                ...
                child: SingleChildScrollView(
                    ...
                    child: Row(
                      children: [
                        SizedBox(
                          width: Dimensions.height10(context) * 0.5,
                        ),
                        Expanded(
                            child: Container(
                                alignment: Alignment.center,
                                ...
                                child: TextField(
                                  ...
                                  decoration: InputDecoration(
                                    contentPadding: EdgeInsets.only(
                                        top: Dimensions.height10(context) * 0.5,
                                        left:
                                            Dimensions.height10(context) * 0.8),
                                    ...
                                    border: OutlineInputBorder(
                                        ...
                                        borderSide: BorderSide(
                                          width: 2.0,
                                          color:
                                              Color.fromARGB(255, 44, 131, 231),
                                        )),
                                    enabledBorder: OutlineInputBorder(
                                        borderRadius: BorderRadius.circular(
                                            Dimensions.radius20(context) * 0.6),
                                        borderSide: BorderSide(
                                          width: 1.0,
                                          color:
                                              Color.fromARGB(255, 44, 131, 231),
