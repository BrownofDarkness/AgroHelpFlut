...
class SearchCultureItem extends StatefulWidget {
  ...
  const SearchCultureItem(
      {super.key, required this.culture, required this.index});
...
class _SearchCultureItemState extends State<SearchCultureItem> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Get.toNamed(
            RouteHelper.getSearchCropDetail(widget.culture.id!, widget.index));
      },
      child: Container(
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  fit: BoxFit.cover,
                  image: NetworkImage("${widget.culture.photo}"),
                ),
              ),
            ),
            Expanded(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SmallText(
                        text: tronk(widget.culture.description!,
