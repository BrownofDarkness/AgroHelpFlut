                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        fit: BoxFit.cover,
                        image:NetworkImage(
                          "${AppConstants.BASE_URL}${widget.fertilizer['image']}",
                        ),
                      )
                    ),
                  ),
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      BigText(text: widget.fertilizer["name"], size: Dimensions.font16(context),),
                      SizedBox(height: Dimensions.height10(context),),
                      SmallText(text: tronk(widget.fertilizer["description"], Dimensions.height15(context)), color: Colors.grey,),
                    ],
                  ),
                ),
              ),
